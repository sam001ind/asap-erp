    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-zinc-900/50 backdrop-blur-md rounded-2xl border border-slate-200 dark:border-zinc-800 p-6 shadow-sm">
          <p className="text-sm font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">System Status</p>
          <p className="text-3xl font-bold text-slate-900 dark:text-white mt-2">Active</p>
          <p className="text-xs text-emerald-500 mt-2 font-medium">All services running smoothly</p>
        </div>
        <div className="bg-white dark:bg-zinc-900/50 backdrop-blur-md rounded-2xl border border-slate-200 dark:border-zinc-800 p-6 shadow-sm">
          ...
          <p className="text-xs text-emerald-500 mt-2 font-medium">Within capacity</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900/50 backdrop-blur-md rounded-3xl border border-slate-200 dark:border-zinc-800 p-6 shadow-sm h-80">
        <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-4">System Load (Global)</h3>
    ...
    <div className="flex-1 overflow-y-auto relative">
      ...
      <div className="p-6 md:p-8 pt-6 max-w-[1600px] mx-auto relative z-10">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Super Admin System Settings</h1>
            <p className="text-slate-500 dark:text-slate-400 font-medium mt-1">Configure your ERP system settings and monitor performance.</p>
          </div>
        </div>
        {content}
      </div>
